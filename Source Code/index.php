...
/**
 * ============================================================================
 * Chat Room System - Main Interface
 * ============================================================================
 *
 * The primary entry point for the application. Handles the user interface,
 * form submission, and overall layout.
 *
 * ----------------------------------------------------------------------------
...
<body onload="ajax(); ">
  ...
  <center>
    <p>
    <h4 style="color:#000dff">Web Designing Laboratory Mini Project</h4>
    </p>
    <p>
        ...
        <div class="form-group">
          <div class="col-sm-offset-2 col-sm-10">
            <td colspan="2" align="center"> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
              <button type="reset" name="reset" class="btn btn-primary">Reset it !</button> &nbsp &nbsp &nbsp &nbsp
  ...
  <footer>
    <center>
      <p style="color:#f70000">“Let us take you into a deeper experience, make a moment a lasting conveyable memory. Let
        us help build your tribe.”</p>
    </center>
  </footer>
</body>
